defmodule TweeterWeb.Router do
  ...
  scope "/", TweeterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TweeterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TweeterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TweeterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TweeterWeb do
    ...
    live_session :current_user,
      on_mount: [{TweeterWeb.UserAuth, :mount_current_user}] do
