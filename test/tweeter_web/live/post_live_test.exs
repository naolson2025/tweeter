defmodule TweeterWeb.PostLiveTest do
  ...
  import Tweeter.TimelineFixtures

  @create_attrs %{body: "some body", username: "some username", likes_count: 42}
  @update_attrs %{body: "some updated body", username: "some updated username", likes_count: 43}
  @invalid_attrs %{body: nil, username: nil, likes_count: nil}
